  ...
  return (
    <>
      <main>
        ...
        <section className="pb-40 bg-blueGray-200 -mt-24">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-6">
              <button className="bg-lightBlue-500 rounded-lg px-4 py-3 text-white font-bold text-lg">
                Go to Rankings
              </button>
            </div>
          </div>
